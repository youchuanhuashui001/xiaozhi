...
typedef enum {
	...
	APP_EVENT_WS_HELLO,
	APP_EVENT_WS_TEXT,
	APP_EVENT_STT_RESULT,
	APP_EVENT_WS_BINARY,
	APP_EVENT_CAPTURE_SILENCE_TIMEOUT,
	APP_EVENT_PLAYBACK_FINISHED,
	APP_EVENT_ERROR,
	APP_EVENT_CONTROL_CONNECT,
	APP_EVENT_CONTROL_DISCONNECT,
	APP_EVENT_CONTROL_SET_SERVER_CONFIG,
	APP_EVENT_CONTROL_SET_AUDIO_CONFIG,
	APP_EVENT_CONTROL_TEST_CONNECTION,
	APP_EVENT_CONTROL_SHUTDOWN,
	APP_EVENT_SHUTDOWN
} app_event_type_t;
